...
#     train_app = data['15_kitchen_outlets'].values
#     X_train.extend(train_mains)
#     Y_train.extend(train_app)
# if i == 2:
#     train_mains = data[['1_mains', '2_mains']].values
#     train_app = data['8_kitchen_outlets'].values
#     X_train.extend(train_mains)
#     Y_train.extend(train_app)
# if i == 3:
#     train_mains = data[['1_mains', '2_mains']].values
#     train_app = data['21_kitchen_outlets'].values
#     X_train.extend(train_mains)
#     Y_train.extend(train_app)
# if i == 4:
#     train_mains = data[['1_mains', '2_mains']].values
#     train_app = data['14_kitchen_outlets'].values
#     X_train.extend(train_mains)
#     Y_train.extend(train_app)
# if i == 5:
#     test_mains = data[['1_mains', '2_mains']].values
#     test_app = data['25_kitchen_outlets'].values
#     X_test.extend(test_mains)
#     Y_test.extend(test_app)
# if i == 6:
#     test_mains = data[['1_mains', '2_mains']].values
#     test_app = data['13_kitchen_outlets'].values
#     X_test.extend(test_mains)
#     Y_test.extend(test_app)
